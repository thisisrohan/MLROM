...
dir_name_data = os.getcwd() + '/saved_data'
...
# plt.tight_layout()
plt.savefig(fln+'u_v_omega-snapshot-t0.png', dpi=300, bbox_inches='tight')
# plt.show()
plt.clf()
...
# plt.tight_layout()
plt.savefig(fln+'u_v_omega-snapshot-contourf-t0.png', dpi=300, bbox_inches='tight')
# plt.show()
plt.clf()
...
for plot_mean_std in [True, False]:
    ...
    if plot_mean_std == True:
        plt.savefig(fln+'mean_std.png', dpi=300, bbox_inches='tight')
    else:
        plt.savefig(fln+'median_IQR.png', dpi=300, bbox_inches='tight')
    # plt.show()
    plt.clf()
# '''
...
# plt.tight_layout()
plt.savefig(fln+'u_v_omega-mean.png', dpi=300, bbox_inches='tight')
# plt.show()
...
# plt.tight_layout()
plt.savefig(fln+'u_v_omega-mean-contourf.png', dpi=300, bbox_inches='tight')
# plt.show()
plt.clf()
...
# plt.tight_layout()
plt.savefig(fln+'u_v_omega-snapshot.png', dpi=300, bbox_inches='tight')
# plt.show()
...
# plt.tight_layout()
plt.savefig(fln+'u_v_omega-snapshot-contourf.png', dpi=300, bbox_inches='tight')
# plt.show()
plt.clf()
