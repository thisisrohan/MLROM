...
class Autoencoder(Model):
    ...
    def __init__(
        ...
        for ks_i in range(num_kernel_sizes):
            ...
            self.encoded_vec_weights.append(scalar_multiplication(trainable_scalar=_trainscalar, init_value=1.0, name=scalarmult_name))
        ...
        for ks_i in range(num_kernel_sizes):
            scalarmult_name = 'scalar_multiplication' + self.create_suffix_from_iter(global_scalarmult_iter)
            global_scalarmult_iter += 1
            self.decoded_vec_weights.append(scalar_multiplication(trainable_scalar=_trainscalar, init_value=1.0, name=scalarmult_name))
