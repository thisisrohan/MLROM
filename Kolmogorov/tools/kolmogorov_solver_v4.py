...
class Kol2D_odd(object):
    ...
    # @tf.function
    def vort(self, u_h, v_h):
        # calculate vorticity
        return self.ddy*u_h - self.ddx*v_h


    # @tf.function
    def dissip(self, u_h, v_h):
    ...
    # @tf.function
    def aap(self, f1, f2, ff1_h, ff2_h, ff1, ff2, p_h):
        ...
        ff1[:, :] = np.fft.irfft2(np.fft.ifftshift(ff1_h), s=ff1_h.shape[-2:]) # must take real part or use irfft2
