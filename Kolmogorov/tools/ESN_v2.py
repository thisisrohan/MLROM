...
class ESN_Cell(layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.Win.build(input_shape=(input_shape[0], input_shape[-1]))
    ...
    def call(self, inputs, states):
        ...
        candidate_state = self.activation(candidate_state + self.Win(inputs))
...
class ESN(Model):
    ...
    def load_weights_from_file(self, file_name):
        ...
        for i in range(len(self.rnn_list)):
            ...
            Wres = self.rnn_list[i].cell.Wres_sp
            K.set_value(Wres_sp.indices, Wres_kernel_sparse_indices)
            K.set_value(Wres_sp.values, Wres_kernel_sparse_values)
