...
class AEESN_ensemble_AR(Model):
    """
    Ensemble AR prediction.
    """
    def __init__(
            self, ae_net, ensemble_list, num_sample_output_AR,
            **kwargs,
            ):
    ...
    def call(self, inputs, **kwargs):
        ...
        inputs = layers.TimeDistributed(self.ae_net.encoder_net)(inputs)
        ...
        for j in range(1, self.num_sample_output_AR):
            data_in_j = layers.TimeDistributed(self.ae_net.encoder_net)(prediction_list[-1])
