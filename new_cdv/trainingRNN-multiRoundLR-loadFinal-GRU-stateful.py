...
def main(rnn_layers_units_each, scalar_weights, RNN_str, AR_AERNN_str, AR_RNN_str):
    strategy = None
    ...
    #     ] # TVD RK2
        ...
        rnn_layers_units = [rnn_layers_units_each]*num_rnn_layers
        # timeMeanofSpaceRMS = np.mean(np.mean(latent_states_all**2, axis=1)**0.5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('rnn_layers_units_each', type=int)
    ...
    print('rnn_layers_units_each : {}, scalar_weights : {}'.format(args.rnn_layers_units_each, args.scalar_weights))
    ...
    main(args.rnn_layers_units_each, scalar_weights, args.rnnss, args.araernn, args.arrnn)
