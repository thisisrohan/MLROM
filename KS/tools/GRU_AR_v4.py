################################################################################
# In this AutoRegressive GRU the output = P1 @ phi + P2 @ phi^2, where phi is  #
# the output of the GRU and P1 is the regular dense layer that normally sits on#
# top of the GRU. P2 is an extension of that dense layer that also acts on the #
