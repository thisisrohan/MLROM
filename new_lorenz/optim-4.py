...
def main(rnn_idx, epochs, patience, AR_RNN_str, AR_AERNN_str):
    strategy = None
    ...
    eval("from tools." + AR_RNN_str[0] + " import " + AR_RNN_str[1] + " as AR_RNN")
    eval("from tools." + AR_AERNN_str[0] + " import " + AR_AERNN_str[1] + " as AR_AERNN")
